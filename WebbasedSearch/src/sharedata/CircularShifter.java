...
=======
     /**
     * OVERVIEW: Constructor, stores a value the reference attribute and
     * creates a list of virtual circularly shifted lines
     * 
     ...
     * reference set repeatedly moving the first word in one line to the end of
     * that line, excludes lines that start with noise words
     */
    public void makeShift() {
        for (int g = 0; g < reference.lineCount(); g++) {
            for (int h = 0; h < reference.wordCountAt(g); h++) {
...
>>>>>>> 61da36a5c4e4589ff10616038571cf3d2256db3d
