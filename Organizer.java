...
public class Organizer {
    ...
    /**
     * EFFECTS: Sorts an ArrayList into alphabetical order based on a certain order (a<A<b<B<…<y<Y<z<Z)
    ...
    private static boolean Compare(String s1, String s2)
    {
        ...
        char ref []= {' ','a','A','b','B','c','C','d','D','e','E','f','F','g','G','h','H','i','I','j','J','l','L','m','M','n','N','o','O','p','P','q','Q','r','R','s','S','t','T','u','U','v','V','w','W','x','X','y','Y','z','Z'};
        int i1 = 0, i2 = 0;
        for(int g=0; g < min; g++)
        {
